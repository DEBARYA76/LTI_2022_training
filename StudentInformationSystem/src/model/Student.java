...
public class Student {
	...
	//private static final String collegeName="LTI SOCHIN SCHOOL";      //blank final:declared  without initialisation
	public Student() {}
	static
	{
	collegeName=	"LTI SCHOOL";
	}
	...
	public static int getRollNoGenerator() {
		return rollNoGenerator;
	}
